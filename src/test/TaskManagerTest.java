...
public class TaskManagerTest {
	...
	public static void main(String[] args) {
		...
		ArbiAgentExecutor.execute("tcp://127.0.0.1:61616", "agent://www.arbi.com/TaskManager", taskManager, BrokerType.ZEROMQ);

		DataSource ds = new DataSource();
		System.out.println("started");
		ds.connect("tcp://127.0.0.1:61616", "ds://www.arbi.com/TaskManager",BrokerType.ZEROMQ);
